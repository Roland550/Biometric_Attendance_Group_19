...
const Lect_fingerprint = ({navigation}) => {
    return (
        ...
        {/* <View style={styles.header} >
         ...
         <View style={styles.fingerprint_Box}>
            <Pressable onPress={() => setTimeout(()=>{navigation.navigate("Lecturer List")},2000)}  style={styles.fingerprint_image_container}>
...
export default Lect_fingerprint